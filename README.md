...
* 21-22: [KubeCon + CloudNativeCon + Open Source Summit + AI dev China 2024]([https://events.linuxfoundation.org/?_sft_lfevent-category=kubecon-cloudnativecon-cncf-events](https://events.linuxfoundation.org/kubecon-cloudnativecon-open-source-summit-ai-dev-china/)) - ¸Hong Kong (China) <a href="TBD"><img alt="KubeCon + CloudNativeCon China" src="https://img.shields.io/static/v1?label=CFP&message=until%20May-2024&color=green"></a>

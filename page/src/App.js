  ...
  render() {
    return (
      <>
        ...
        <YearSelector year={this.state.selectedYear} onChange={this.renderYear.bind(this)} />
        ...
        <CalendarGrid year={this.state.selectedYear} displayDate={this.displayDate.bind(this)} />
